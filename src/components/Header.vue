<template>
  <header class="flex flex-shrink-0 fixed top-0 inset-x-0 z-100 sm:z-200 justify-center h-16">
    <div class="flex items-center flex-shrink-0 px-4 py-3 bg-gray-700 lg:w-64 lg:bg-gray-800">
      <button
        @click="$store.commit('TOGGLE_SIDEBAR', true)"
...
export default {
  ...
  data () {
    return {
      ...
      user: {
        avatar:
          'https://img.alicdn.com/tfscom/i6/TB14NFSOFXXXXXDXVXXYXGcGpXX_M2.SS2_460x460xz.jpg'
      }
    }
  }
}
