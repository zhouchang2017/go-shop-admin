<template>
  ...
  >
    <div class="flex items-center w-error">
      ...
      <div>
        <h1 class="text-6xl text-gray-800 font-normal mb-1">404</h1>
        <p class="text-2xl mb-6">Whoops</p>
        <p class="text-xl mb-8 leading-normal">
          "We're lost in space. The page you were trying to view does not
          exist."
        </p>
        <router-link
          :to="{ name: 'dashboard' }"
